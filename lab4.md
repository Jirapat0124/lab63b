...
## การบันทึกผลการทดลอง
* เมื่อรันโปรแกรมสำเร็จ จะขึ้นคำว่าread 1 ซึ่งหลอดไฟLED ไม่ติด เมื่อจิ้มอินพุทในพอร์ท0 จะได้ค่าread 0 ซึ่งทำให้หหลอดไฟส่องสว่าง อีกทั้งปุ่มสีดำของไมโครคอนโทรเลอร์ก็เชื่อมกับport0เช่นกัน ทำให้เวลากด
ปุ่มสีดำ หลอดไฟLED จะเปล่งแสงออกมา
* เมื่อนำcensorแสง มาต่อเข้ากับวงจร ทำให้แสงจะส่องสว่างเฉพาะเวลาที่เอานิ้วบังcensorรับแสง เพราะเมื่อบังแสงcensorจะเข้าพอร์ท0 ทำให้แสงส่องสว่าง

## อภิปรายผลการทดลอง
* จากการทดลองเขียนโปรแกรม เมื่อสัญญาณอินพุทเข้าport0 ทำให้ไฟส่องสว่างหรือไม่ส่องสว่าง ดังนั้นport0คือตัวกำหนดว่าหลอดไฟLEDจะส่องสว่างหรือไม่ ซึ่งเวลาอ่านค่าจะแสดงผลบนหน้าจอ
* เมื่อต่อเข้ากับcensorรับแสง เวลาเอานิ้วบังแสง แรงต้านทานสูงทำให้อินพุทเป็น1 อ่านค่า1 ทำให้หลอดไฟLEDไม่เล่งแสงออกมา และเมื่อเอานิ้วออก แรงต้านทานน้อยทำให้อ่าค่าได้0 แสงจากหลอดไฟLEDก็จะส่องสว่าง

## คำถามหลังการทดลอง
เซนเซอร์รับแสงสามารถนำไปประยุกต์ใช้กับชีวิตประจำวันได้หรือไม่
* ได้ เพราะในปัจจุบันเรามีการใช้censorรับแสงหลายแบบมาก เช่น ไฟข้างทาง ไฟริมรั้ว เป็นต้น
